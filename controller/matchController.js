...
//       const questionAnswers = gameRoom.playerAnswers.get(
//         gameRoom.currentQuestionIndex
//       );
...
//       const isCorrect =
//         String(data.answer).trim() === String(currentQuestion.answer).trim();
//       const answerData = {
//         answer: data.answer,
//         isCorrect,
//         timeSpent: data.timeSpent,
...
//       if (answerData.isCorrect) {
//         playerScore.streak++;
//         playerScore.maxStreak = Math.max(
//           playerScore.maxStreak,
//           playerScore.streak
//         );
//         playerScore.correctAnswers++;
...
//           if (player.rating <= tier.max) {
//             qmChange =
//               currentQuestion.finalLevel <= tier.thresh
//                 ? isCorrect
//                   ? 2
//                   : -1
//                 : isCorrect
...
//         console.log(
//           `Player ${player.id} controls QM. Change: ${qmChange}, New QM: ${gameRoom.questionMeter}`
//         );
//       }
...
//               0,
//               gameRoom.gameSettings.totalGameTime -
//                 (Date.now() - gameRoom.createdAt)
//             ),
//             questionMeter: gameRoom.questionMeter,
//             questionMeterController: gameRoom.questionMeterController,
//             difficulty: gameRoom.difficulty,
...
//             gameRoom.currentQuestionIndex <
//             gameRoom.gameSettings.questionsPerGame;

//           if (hasMoreQuestions) {
//             // Generate next question based on updated QM
//             import("./services/questionService.js").then(
//               ({ generateQuestion }) => {
//                 try {
//                   const lowerRating = Math.min(
//                     gameRoom.players[0].rating,
//                     gameRoom.players[1].rating
//                   );
//                   const nextQuestion = generateQuestion(
//                     gameRoom.difficulty,
//                     gameRoom.symbols,
...
//                   gameRoom.questions.push(nextQuestion);
//                   console.log(
//                     `Generated question ${gameRoom.questions.length} with QM: ${gameRoom.questionMeter}, Level: ${nextQuestion.finalLevel}`
//                   );
...
//                         ),
//                         questionMeter: gameRoom.questionMeter,
//                         questionMeterController:
//                           gameRoom.questionMeterController,
//                         difficulty: gameRoom.difficulty,
//                       },
//                       questionMeter: gameRoom.questionMeter,
//                     });
...
//                   Math.pow(
//                     10,
//                     (opponent.currentRating - player.currentRating) / 400
//                   ));
//               const actualScore = player.playerId === winner.playerId ? 1 : 0;
